...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_rooms_hero_gradient_color" AS ENUM('from-red-500 to-yellow-400', 'from-red-500 to-orange-400', 'from-blue-500 to-purple-400', 'from-green-500 to-teal-400');
  ...
  CREATE TABLE "rooms" (
  	...
  	"hero_gradient_color" "enum_rooms_hero_gradient_color" DEFAULT 'from-red-500 to-yellow-400',
  ...
  CREATE INDEX "posts_hero_idx" ON "posts" USING btree ("hero_id");
  ...
  CREATE INDEX "_posts_v_version_version_hero_idx" ON "_posts_v" USING btree ("version_hero_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_rooms_hero_gradient_color";
