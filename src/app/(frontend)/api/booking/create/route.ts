...
export async function POST(request: NextRequest) {
  try {
    ...
    // Fetch the rate details to get the hourly amount
    ...
    const pricing = calculatePrice(
      hourlyRate,
      body.duration,
      false // TODO: Check if client is monthly
    );
...
function validateBookingRequest(booking: BookingRequest): string | null {
  ...
  if (!['rehearsal', 'recording', 'rehearsal-recording'].includes(booking.sessionType)) {
